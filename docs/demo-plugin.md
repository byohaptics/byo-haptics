...
The simulated devices use base positions `(-0.34, 0, 0)` and `(0.34, 0, 0)` relative to the plugin root. This places them close to the Host UI panel while retaining clearance during their exaggerated rotation.
